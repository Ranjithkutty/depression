...
if(isset($btn))
{
$max_qry = mysql_query("select max(id) maxid from keyword_neg");
	$max_row = mysql_fetch_array($max_qry);
	$id=$max_row['maxid']+1;

$q1="insert into keyword_neg(id,keyword,reply) 
values($id,'$keyword','$reply')";
$q2=mysql_query($q1);
?>
...
if($act=="ok")
{
mysql_query("delete from keyword_neg where id=$did");
?>
<script language="javascript">
window.location.href="add_data.php";
</script>
...
<div class="wrapper row1">
  ...
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      ...
      <li class="active"><a href="add_data.php">Dataset</a></li>
	  <li><a href="detect.php">Detection</a></li>
...
<form name="form1" method="post" action="">
  ...
  <table width="407" height="123" border="1" align="center">
    <tr>
      <td width="172">Depression Data </td>
      <td width="219"><textarea name="keyword"></textarea></td>
    </tr>
    <tr>
      <td>Solution</td>
  ...
  <p align="center">&nbsp;</p>
  <?php
  $q1=mysql_query("select * from keyword_neg");
  ...
  <table width="80%" border="1" align="center">
    ...
    <tr>
      <td><?php echo $i; ?></td>
      <td><?php echo $r1['keyword']; ?></td>
      <td><?php echo $r1['reply']; ?></td>
      <td><?php echo '<a href="add_data.php?act=ok&did='.$r1['id'].'">Delete</a>'; ?></td>
    </tr>
	<?php
	}
	?>
